...
def render_header():
    ...
    st.info("Version: v1.3.1 | Last Updated: {} | Maintained By: StreamlitAuditSystem | Status: Live".format(datetime.datetime.now().strftime("%Y-%m-%d")))
...
tabs = {
    ...
    "Assistant Builder UI": "assistant_builder_tab.py"
}
